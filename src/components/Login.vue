<template>
  ...
  <div class="inputForm">
    ...
    <input type="text" v-model="email" class="input" placeholder="Digite Seu Email">
  </div>
...
<div class="flex-column">
  ...
  <div class="inputForm">
    ...
    <input type="password" class="input"  v-model="password" placeholder="Digite Sua senha">
...
<button class="button-submit" @click="register">Entrar</button>
<p class="p">Ainda nao tem uma conta?<span class="span"><router-link to="/register">Criar conta.</router-link></span>

</p><p class="p line">Ou tente</p>
